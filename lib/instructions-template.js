...
- Each op also carries an \`expected_visible_change\` field — a one-sentence
  natural-language description of what the visitor should now see (e.g.
  "Change <h1> text from 'Welcome' to 'Hello'"). Use it as a sanity-check:
  if the structural check passes but the description obviously doesn't match
  the live page, flag for manual review.
